    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            if(i==indexPath.row){
                ...
                let alertController = UIAlertController(title: "Cannot Delete", message: "Last Record is required for future reference, please delete only the previous records except the last one", preferredStyle: UIAlertControllerStyle.alert) 
